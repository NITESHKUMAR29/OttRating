...
class Details : AppCompatActivity() {
    ...
    private fun search(sendString: String) {
        ...
        val request = Request.Builder()
            .url(sendString)
            .get()
            .addHeader("x-rapidapi-key", "5a01c403a6msh14ee07f4e497edap12128bjsn6606296001ff")
            ...
            override fun onResponse(call: Call, response: Response) {
                ...
                for(i in 0 until jsonArray.length()){
                    ...
                    runOnUiThread{
                        ...
                        val linearLayoutManager = LinearLayoutManager(this@Details , LinearLayoutManager.VERTICAL, false)
